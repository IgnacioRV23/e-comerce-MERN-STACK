    ...
    return (
        <div className="container_category">
            <section className="category">
                ...
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgElec')} onMouseLeave={e => titleLeave('imgElec')}>Electrónica</a>
            </section>
            ...
            <section className="category">
                ...
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgWoman')} onMouseLeave={e => titleLeave('imgWoman')}>Mujer</a>
            </section>
            ...
            <section className="category">
                ...
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgCare')} onMouseLeave={e => titleLeave('imgCare')}>Salud y belleza</a>
            </section>
            ...
            <section className="category-home category">
                ...
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgHome')} onMouseLeave={e => titleLeave('imgHome')}>Hogar</a>
            </section>
            ...
            <section className="category">
                ...
                <img src={imgCategory.man2} alt="category-man" className="category-hidden"
                    id="imgMan" />
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgMan')} onMouseLeave={e => titleLeave('imgMan')}>Hombre</a>
            </section>
            ...
            <section className="category">
                ...
                <img src={imgCategory.kids2} alt="category-kids" className="category-hidden"
                    id="imgKids" />
                <a href="#" className="title-category" onMouseOver={e => titleHover('imgKids')} onMouseLeave={e => titleLeave('imgKids')}>Infantil</a>
            </section>
        </div>
    )
};